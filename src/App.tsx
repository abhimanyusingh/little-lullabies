  ...
  function App() {
	...
	return (
	  <div className="min-h-screen bg-gradient-to-b from-[#ffafcc] via-[#b388eb] to-[#ff8fab]">
		...
		{/* Hero Section */}
		<header className="relative py-16 px-6 text-center bg-gradient-to-r from-purple-200 via-pink-200 to-red-200">
		  ...
		  <div className="relative">
			...
			<p className="text-gray-700 max-w-2xl mx-auto text-lg leading-relaxed font-[Caveat] text-2xl text-pink-600">
			  {CHANNEL_DESCRIPTION}
			</p>
		  </div>
		</header>
